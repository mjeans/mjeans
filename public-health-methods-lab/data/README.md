...
This lab does not include row-level health records. All surveillance counts, denominators, outbreak table cells, and retention times are deterministic synthetic fixtures defined in `scripts/run_analysis.py`.
